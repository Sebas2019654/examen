...
public class MainActivity extends AppCompatActivity {
    ...
    public void CrearBase(){
        ...
        btnCrearBase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (db != null){
                    Toast.makeText(MainActivity.this, "Base Proveedor Creada", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(MainActivity.this, "Base Proveedor Creada", Toast.LENGTH_SHORT).show();
                }
    ...
    public void CrearUsuario(){
        ...
        btnCrearUsuario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, Crear_proveedor.class);
    ...
    public void BuscarVer(){
        ...
        btnBuscarEditar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, EditarProveedor.class);
                startActivity(intent);
            }
        });
    }
