...
public class AdaptadorProveedor extends RecyclerView.Adapter<AdaptadorProveedor.ViewHolderDatos> {

    ArrayList<Proveedor>lista_users;

    public AdaptadorProveedor(ArrayList<Proveedor> lista_users) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderDatos holder, int position) {
            holder.txtId.setText(lista_users.get(position).getRuc());
            holder.txtNombre.setText(lista_users.get(position).getNombre_comercial());
            holder.txtPass.setText(lista_users.get(position).getRepresentante_legal());
            holder.txtPermisos.setText(lista_users.get(position).getDireccion());
